...
export const metadata = pageMeta({
  title: "Kebijakan Privasi — AMAN Digital",
  description:
    "Data apa yang kami kumpulkan di amandigital.my.id, untuk apa dipakai, berapa lama disimpan, dan hak Anda atasnya.",
  path: "/kebijakan-privasi",
});

/**
 * Isinya DIBACA dari `docs/legal/kebijakan-privasi.md` saat build, bukan
 * disalin ke sini.
 *
 ...
 */
function bacaKebijakan(): string {
  const berkas = path.join(process.cwd(), "docs", "legal", "kebijakan-privasi.md");
  return fs.readFileSync(berkas, "utf8");
}

export default function KebijakanPrivasiPage() {
  const isi = bacaKebijakan();
