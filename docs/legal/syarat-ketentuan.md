...
**AMAN Digital** adalah **usaha perorangan** milik **Adya Malik**,
berkedudukan di Blangpidie, Aceh Barat Daya, Indonesia.

Kontak: adya.malik2@gmail.com · WhatsApp +62 822-1076-8038

---

## 2. Apa yang kami sediakan

**Layanan** — dikerjakan untuk klien, harga disepakati per kasus:
Data & System · IT Advisor · Print Center · Creative Studio

**Produk digital** — barang jadi, bayar lalu langsung dipakai:
AMAN Engine · AMAN Content Engine · AMAN Poster Generator ·
Produk Digital (700+)

**Aplikasi** — AMAN Kasir · AMAN Budget · AMAN Invoice · AMAN-in

**AMAN News** — portal berita dan artikel.

---

## 3. Pembelian dan pembayaran

Pembayaran produk digital diproses oleh **Lynk.id**. Kami tidak menerima,
memproses, atau menyimpan data kartu maupun rekening Anda.
...
## 4. TIDAK ADA PENGEMBALIAN DANA

**Pembelian produk digital di AMAN Digital tidak dapat dikembalikan
(non-refundable).**

Alasannya: begitu kode akses diserahkan, produk sudah dapat diakses
sepenuhnya dan tidak mungkin "dikembalikan" seperti barang fisik.

Ketentuan ini berlaku untuk seluruh produk digital, termasuk bila:

- Anda berubah pikiran setelah membeli;
- Anda merasa produknya tidak sesuai harapan;
- Anda tidak jadi memakainya.

**Sebelum membeli, pastikan Anda sudah membaca keterangan produk.** Kalau ada
yang ingin ditanyakan, hubungi kami dulu lewat WhatsApp — kami siap menjawab
sebelum Anda memutuskan.

> **Catatan untuk Malik:** ketentuan ini **wajib terlihat sebelum pembeli
> membayar**, bukan hanya tersembunyi di halaman S&K. Saran: satu baris
> pendek di setiap halaman produk, dekat tombol beli. Kalau hanya ada di
> sini, secara praktis dianggap tidak diberitahukan.

---

## 5. Kode akses

Berdasarkan cara sistem bekerja saat ini:
...
Untuk Data & System, IT Advisor, Print Center, dan Creative Studio:

- Lingkup pekerjaan, harga, dan waktu pengerjaan **disepakati lebih dahulu**
  lewat WhatsApp sebelum pekerjaan dimulai.
...
## 9. Aturan memakai AMAN News

### Komentar

Semua komentar **dimoderasi sebelum tampil**. Kami berhak menolak atau
menghapus komentar yang:

- mengandung SARA, ujaran kebencian, atau ancaman;
- memuat spam, promosi terselubung, atau tautan berbahaya;
- menyerang pribadi seseorang;
- membocorkan data pribadi orang lain;
- melanggar hukum yang berlaku di Indonesia.

Dengan mengirim komentar, Anda memberi kami izin menampilkannya di situs ini.
Anda dapat meminta penghapusan komentar Anda kapan saja — lihat Kebijakan
Privasi bagian 6.

### Isi artikel

Artikel di AMAN News bersifat **informasi umum**, bukan nasihat hukum,
keuangan, medis, atau profesional. Keputusan yang Anda ambil berdasarkan
artikel kami adalah tanggung jawab Anda sendiri.

Kami berusaha menyajikan informasi yang akurat, tetapi tidak menjamin seluruh
isi bebas dari kekeliruan.

### Koreksi dan hak jawab

Kalau Anda menemukan kekeliruan, atau merasa dirugikan oleh isi artikel kami,
hubungi kami lewat kontak di bagian 1. Kami menanggapi dalam **1×24 jam**.

### Tautan afiliasi

Sebagian artikel memuat tautan produk yang diberi label **"Bersponsor"**.
Kami dapat memperoleh komisi bila Anda membeli lewat tautan tersebut, **tanpa
...
AMAN Engine, AMAN Content Engine, dan AMAN Poster Generator memakai layanan
AI pihak ketiga (Google Gemini).

- Hasil keluaran AI **tidak dijamin akurat**. Selalu periksa sebelum dipakai,
...
Aplikasi menyimpan data **di perangkat Anda**, dan sebagian mendukung
pencadangan ke cloud bila Anda masuk dengan akun.

- **Pencadangan adalah tanggung jawab bersama.** Kami menyediakan fiturnya;
  Anda yang menjalankannya. Kami **tidak dapat memulihkan data yang tidak
  pernah dicadangkan**.
- Aplikasi akan memiliki syarat dan kebijakan privasinya sendiri.

---

## 12. Batasan tanggung jawab

Layanan disediakan sebagaimana adanya. Dalam batas yang diizinkan hukum, kami
tidak bertanggung jawab atas kehilangan keuntungan, kehilangan data, atau
kerugian tidak langsung yang timbul dari pemakaian layanan ini.

> **Catatan untuk Malik:** paragraf ini sebaiknya dibaca orang yang paham
> hukum sebelum terbit. Saya dapat menyusun kalimatnya, tetapi **saya bukan
> penasihat hukum** dan tidak boleh dianggap begitu.
...
Kami dapat memperbarui ketentuan ini sewaktu-waktu. Tanggal di bagian atas
menunjukkan versi terakhir. Perubahan yang berdampak besar akan kami umumkan
di situs.
